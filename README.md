...
----------------
  ...
  |   Что такое RLE? Эту информацию можно найти в Wiki.
  |
 Тоже самое, что и VRLE8, но отличие в размере "порции".
 VRLE16 не было на ПК Вектор-06Ц!
```
...
<br>
**Репозиторий:** [Blender 3D. Логотип для алгоритма VRLE8 и для алгоритма VRLE16](https://github.com/drilnet/blender3d-logovrle8-logovrle16)
<br>
